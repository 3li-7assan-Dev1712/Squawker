...
@ContentProvider(
        authority = SquawkProvider.AUTHORITY2,
        database = SquawkDatabase.class)
public final class SquawkProvider {

    public static final String AUTHORITY2 = "com.example.squawker.provider";
    ...
    public static class SquawkMessages {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY2 + "/messages");
    }
}